...
export default function About() {
    ...
    const handleDarkMode = () => {
        if (myStyle.color=='black') {
            ...
            document.getElementById('theme').innerHTML="Enable light mode"
    ...
    return (
        <div className='container' style={myStyle}>
            ...
            <button className='btn btn-primary my-3' id="theme" onClick={handleDarkMode}>Enable dark mode</button>
